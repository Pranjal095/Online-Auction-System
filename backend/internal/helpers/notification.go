...
func SendAuctionEmail(ctx context.Context, receiver string, notifType notifType, auctionID int, additionalData map[string]interface{}) error {
    auction, err := db.GetAuctionByID(ctx, auctionID)
    if err != nil {
